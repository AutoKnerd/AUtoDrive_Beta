...
import { buildUniqueRecommendedTestingLesson } from '@/lib/lessons/auto-recommended';
...
export async function POST(req: Request) {
  ...
  try {
    ...
    if (role === 'global') {
      return NextResponse.json({ message: 'Bad Request: global role is not supported for testing lessons.' }, { status: 400 });
    }
    ...
    console.error('[API createUniqueRecommendedTesting] Error:', {
